...
export const colors = css`
  ...
  --danger-color-900: hsl();

  --warning-color-100: hsl();
  --warning-color-200: hsl();
  --warning-color-300: hsl();
  --warning-color-400: hsl();
  --warning-color-500: hsl();
  --warning-color-600: hsl();
  --warning-color-700: hsl();
  --warning-color-800: hsl();
  --warning-color-900: hsl();

  --success-color-100: hsl();
  --success-color-200: hsl();
  --success-color-300: hsl();
  --success-color-400: hsl();
  --success-color-500: hsl();
  --success-color-600: hsl();
